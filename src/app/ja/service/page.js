...
const SERVICES = [
    { id: "web-development", label: "ウェブ開発",   sub: "企業サイト・業務システム" },
    { id: "app-development", label: "アプリ開発",   sub: "iOS / Android" },
    { id: "sql-database",    label: "データベース", sub: "MySQL 設計・運用" },
    { id: "japanese-study",  label: "日本語教育",   sub: "エンジニア向け日本語" },
];
