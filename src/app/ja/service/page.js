          ...
          <div className={styles.web_dev__content}>
            <div className={styles.web_dev__text}>
              <p className={styles.web_dev__description}>
                ...
                サービス内容は多岐にわたり、すべてのデバイスに対応する完全レスポンシブなWebデザイン、高機能でユーザー体験に優れたECサイトの構築、直感的に操作できるCMSとのスムーズな連携などを含んでいます。
          ...
          <div className={styles.app_dev__content}>
            <div className={styles.app_dev__text}>
              <p className={styles.app_dev__description}>
                ...
                経験豊富な開発チームが、お客様のアイデアやビジョンを、確かな技術で形にします。
          ...
          <div className={styles.app_dev__content}>
            <div className={styles.app_dev__text}>
              <p className={styles.app_dev__description}>
                ...
                大規模なデータベースや複雑なデータセットにおいても、経験豊富な専門チームが高精度かつ信頼性の高い手法で、あらゆるデータ管理業務に対応します。
                提供するサービスには、パフォーマンス向上と読み込み時間の短縮を実現する高度なクエリ最適化に加え、必要な情報を必要なときに正確に抽出できる高精度なデータ抽出技術が含まれます。
                さらに、データに基づく意思決定を支援するための、動的かつ視覚的にわかりやすいレポートの自動生成にも対応しています。
          ...
          <div className={styles.app_dev__content}>
            <div className={styles.app_dev__text}>
              <p className={styles.app_dev__description}>
                ...
                各レベルに合わせたコースで、**「話す」「読む」「書く」「聞く」**の4つの基本スキルをバランスよく学び、実践的なコミュニケーション力を身につけます。                     
